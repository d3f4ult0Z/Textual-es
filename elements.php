    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        <div class="main-slider owl-single dots-absolute owl-carousel">
          <img src="<?php bloginfo('template_url'); ?>/images/img_h_1.jpg" alt="Image" class="img-fluid">
          <img src="<?php bloginfo('template_url'); ?>/images/img_h_2.jpg" alt="Image" class="img-fluid">
          <img src="<?php bloginfo('template_url'); ?>/images/img_h_3.jpg" alt="Image" class="img-fluid">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        <div class="row gutter-1 gallery">
          <div class="col-4">
            <a href="<?php bloginfo('template_url'); ?>/images/img_h_1.jpg" class="gal-item" data-fancybox="gal"><img src="images/img_h_1.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-4">
            <a href="<?php bloginfo('template_url'); ?>/images/img_h_2.jpg" class="gal-item" data-fancybox="gal"><img src="images/img_h_2.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-4">
            <a href="<?php bloginfo('template_url'); ?>/images/img_h_3.jpg" class="gal-item" data-fancybox="gal"><img src="images/img_h_3.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-4">
            <a href="<?php bloginfo('template_url'); ?>/images/img_h_4.jpg" class="gal-item" data-fancybox="gal"><img src="images/img_h_4.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-4">
            <a href="<?php bloginfo('template_url'); ?>/images/img_h_5.jpg" class="gal-item" data-fancybox="gal"><img src="images/img_h_5.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-4">
            <a href="<?php bloginfo('template_url'); ?>/images/img_h_6.jpg" class="gal-item" data-fancybox="gal"><img src="images/img_h_6.jpg" alt="Image" class="img-fluid"></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="main-slider owl-single owl-carousel">
          <div class="testimonial mx-auto">
            <figure class="img-wrap">
              <img src="<?php bloginfo('template_url'); ?>/images/person_2.jpg" alt="Image" class="img-fluid">
            </figure>
          ...
          <div class="testimonial mx-auto">
            <figure class="img-wrap">
              <img src="<?php bloginfo('template_url'); ?>/images/person_3.jpg" alt="Image" class="img-fluid">
            </figure>
          ...
          <div class="testimonial mx-auto">
            <figure class="img-wrap">
              <img src="<?php bloginfo('template_url'); ?>/images/person_4.jpg" alt="Image" class="img-fluid">
            </figure>
